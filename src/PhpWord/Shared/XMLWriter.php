 ...
 * @method bool startDocument(StringFormat $version = 1.0, StringFormat $encoding = null, StringFormat $standalone = null)
 * @method bool startElement(StringFormat $name)
 * @method bool text(StringFormat $content)
 * @method bool writeAttribute(StringFormat $name, mixed $value)
 * @method bool writeElement(StringFormat $name, StringFormat $content = null)
 * @method bool writeRaw(StringFormat $content)
 */
class XMLWriter
{
