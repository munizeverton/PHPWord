...
use MunizEverton\PhpWord\Style\Numbering as NumberingStyle;
use MunizEverton\PhpWord\Style\NumberingLevel;
...
class Numbering extends AbstractPart
{
     ...
     * @param \MunizEverton\PhpWord\Style\NumberingLevel $level
     * @return void
     */
